...
def main():
    ...
    # data = api.get_crdc_ap_segment(2013, race_segment=True, sex_segment=True, race=1, sex=1)
    # data = api.get_crdc_college_exam_segment(2013, race_segment=True, sex_segment=True, race=1, sex=1)
    # data = api.get_crdc_staff(2015, fips=1, teachers_fte_crdc=10)
    # data = api.get_crdc_math_science_enrollment_segment(2017, race_segment=True, sex_segment=True, race=1, sex=1)
    # data = api.get_crdc_algebra_enrollment_segment(2017, race_segment=True, sex_segment=True, race=1, sex=1)
    # data = api.get_crdc_offenses(2017, fips=1, firearm_incident_ind=1)
    # data = api.get_crdc_dual_enrollment_segment(2017, race_segment=True, sex_segment=True, race=1, sex=1)
    # data = api.get_crdc_credit_recovery(2017, fips=1)
    ...
    # data = api.get_crdc_retention_segment(2017, 3, race_segment=True, sex_segment=True, fips=13)
    # data = api.get_edfacts_state_assessments(2017, 8)
    # data = api.get_edfacts_state_assessment_segment(2017, 8, "race", fips=1, race=1)
